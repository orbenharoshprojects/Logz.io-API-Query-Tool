...
- **Region - Endpoint**: The Can be found in Logz.io under the "Settings" page. For more info, click [here]([http://localhost:8000](https://docs.logz.io/user-guide/accounts/account-region.html)). 
> Ex. if your account has "us-east-1" under the "Setting" page, your used region is "US East". 
